      ...
      <div className="row  mt-5 mb-5">
        ...
        <div className="col-6 p-5">
          ...
          <p className="fs-5" style={{ lineHeight: "1.8" }}>
            ...
            the latest updates on our <a href="https://zerodha.com/z-connect/" style={{ textDecoration: "none" }}>blog</a> or see what the media is saying about
