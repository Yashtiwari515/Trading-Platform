...
const WatchList = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/allWatchlists`, {
  ...
  const labels = allWatchlists.map((subArr) => subArr["name"]);
...
const WatchListActions = ({ uid, price }) => {
  ...
  const handleBuyClick = () => {
    generalContext.openTradeWindow(uid, price, "BUY");
  };

  const handleSellClick = () => {
    generalContext.openTradeWindow(uid, price, "SELL");
  };
